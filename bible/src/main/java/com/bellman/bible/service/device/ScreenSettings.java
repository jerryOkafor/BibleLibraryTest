...
public class ScreenSettings {
    ...
    public static boolean isScreenOn() {
        PowerManager pm = (PowerManager) CurrentActivityHolder.getInstance().getApplication().getSystemService(Context.POWER_SERVICE);
    ...
    public static int getContentViewHeightDips() {
        ...
        if (contentViewHeightPx > 0) {
            ...
            heightPx = CurrentActivityHolder.getInstance().getApplication().getResources().getDisplayMetrics().heightPixels;
        }

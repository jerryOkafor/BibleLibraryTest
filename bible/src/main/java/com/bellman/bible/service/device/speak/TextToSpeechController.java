package com.bellman.bible.service.device.speak;
...
import com.bellman.bible.android.control.event.phonecall.PhoneCallMonitor;
import com.bellman.bible.android.control.event.phonecall.PhoneCallStarted;
...
import com.bellman.bible.service.device.speak.event.SpeakEvent.SpeakState;
...
public class TextToSpeechController implements TextToSpeech.OnInitListener, TextToSpeech.OnUtteranceCompletedListener {
    ...
    private TextToSpeechController() {
        ...
        context = CurrentActivityHolder.getInstance().getApplication().getApplicationContext();

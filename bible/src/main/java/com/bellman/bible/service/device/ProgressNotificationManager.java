...
import com.bellman.bible.android.view.activity.download.ProgressStatus;
...
public class ProgressNotificationManager {
    private static final String TAG = "ProgressNotManager";
    ...
    private Notification findOrCreateNotification(Progress prog) {
        ...
        if (notification == null) {
            ...
            final PendingIntent pendingIntent = PendingIntent.getActivity(CurrentActivityHolder.getInstance().getApplication(), 0, intent, 0);
    ...
    private NotificationManager getNotificationManager() {
        ...
        return (NotificationManager) CurrentActivityHolder.getInstance().getApplication().getSystemService(Application.NOTIFICATION_SERVICE);

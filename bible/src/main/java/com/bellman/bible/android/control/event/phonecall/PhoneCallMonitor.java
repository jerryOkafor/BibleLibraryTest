package com.bellman.bible.android.control.event.phonecall;
...
public class PhoneCallMonitor {
    ...
    private TelephonyManager getTelephonyManager() {
        return (TelephonyManager) CurrentActivityHolder.getInstance().getApplication().getSystemService(Context.TELEPHONY_SERVICE);
    }

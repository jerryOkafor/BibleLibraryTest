...
public class PageTiltScrollControl {
    ...
    public static boolean isOrientationSensor() {
        if (mIsOrientationSensor == null) {
            SensorManager sm = (SensorManager) CurrentActivityHolder.getInstance().getApplication().getSystemService(Context.SENSOR_SERVICE);
            if (sm != null) {
...
//			Log.d(TAG, "Recalculating home/noscroll pitch "+normalisedPitch);
    ...
    private void connectListeners() {
        mDisplay = ((WindowManager) CurrentActivityHolder.getInstance().getApplication().getSystemService(Context.WINDOW_SERVICE)).getDefaultDisplay();

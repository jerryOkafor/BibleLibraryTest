package com.bellman.bible.android.view.activity.installzip;
...
class ZipHandler extends AsyncTask<Void, Integer, Integer> {
    ...
    protected Integer doInBackground(Void... params) {
        try {
            ...
            Log.e(InstallZip.TAG, "Error occurred", e);
            return R_ERROR;
    ...
    protected void onPostExecute(Integer result) {
        ...
        switch (result) {
            ...
            case R_MODULE_EXISTS:
                ...
                break;
            case R_OK:
                Toast.makeText(this.parent, R.string.install_zip_successful, Toast.LENGTH_SHORT).show();

...
import com.bellman.bible.service.common.AndRuntimeException;
import com.bellman.bible.service.common.CommonUtils;
import com.bellman.bible.service.device.speak.TextToSpeechController;
    ...
    public void speakToggleCurrentPage() {
        ...
        if (isPaused()) {
            ...
            try {
                ...
                Toast.makeText(CurrentActivityHolder.getInstance().getContext(), R.string.speak, Toast.LENGTH_SHORT).show();
            } catch (Exception e) {
...
//				textToSpeak.add("\n");
    ...
    public void rewind() {
        if (isSpeaking() || isPaused()) {
            ...
            TextToSpeechController tts = TextToSpeechController.getInstance();
            tts.rewind();
            Toast.makeText(CurrentActivityHolder.getInstance().getContext(), R.string.rewind, Toast.LENGTH_SHORT).show();
        }
    }
    ...
    public void forward() {
        if (isSpeaking() || isPaused()) {
            ...
            TextToSpeechController tts = TextToSpeechController.getInstance();
            tts.forward();
            Toast.makeText(CurrentActivityHolder.getInstance().getContext(), R.string.forward, Toast.LENGTH_SHORT).show();
        }
    }
    ...
    public void pause() {
        if (isSpeaking() || isPaused()) {
            ...
            Toast.makeText(CurrentActivityHolder.getInstance().getContext(), pause + "\n" + timeProgress, Toast.LENGTH_SHORT).show();
        }
    }
    ...
    public void stop() {
        ...
        doStop();
        Toast.makeText(CurrentActivityHolder.getInstance().getContext(), R.string.stop, Toast.LENGTH_SHORT).show();
    }

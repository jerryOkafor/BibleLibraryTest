...
abstract public class DocumentSelectionBase extends ListActivityBase implements ListActionModeHelper.ActionModeActivity {
    ...
    protected void showAbout(Book document) {
        ...
        if (StringUtils.isNotBlank(copyrightMerged)) {
            String copyrightMsg = CurrentActivityHolder.getInstance().getApplication().getString(R.string.about_copyright, copyrightMerged);
            about += "\n\n" + copyrightMsg;
        }
        ...
        if (versionObj != null) {
            String versionMsg = CurrentActivityHolder.getInstance().getApplication().getString(R.string.about_version, versionObj.toString());
            about += "\n\n" + versionMsg;
        }
        ...
        if (document instanceof SwordBook) {
            ...
            String versificationMsg = CurrentActivityHolder.getInstance().getApplication().getString(R.string.about_versification, versification.getName());
            about += "\n\n" + versificationMsg;
        }
    ...
    public void setSelectedBookCategory(BookCategory bookCategory) {
        switch (bookCategory) {
            case BIBLE:
                ...
                break;
            case COMMENTARY:
                selectedDocumentFilterNo = 1;
                break;
            case DICTIONARY:
                selectedDocumentFilterNo = 2;
                break;
            case GENERAL_BOOK:
                selectedDocumentFilterNo = 3;
                break;
            case MAPS:
                selectedDocumentFilterNo = 4;
                break;
            default:
                selectedDocumentFilterNo = 0;
                break;

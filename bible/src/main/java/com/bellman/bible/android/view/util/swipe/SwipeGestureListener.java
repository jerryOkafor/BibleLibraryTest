package com.bellman.bible.android.view.util.swipe;
...
public class SwipeGestureListener extends SimpleOnGestureListener {
    ...
    public SwipeGestureListener(SwipeGestureEventHandler compareTranslationActivity) {
        ...
        minScaledVelocity = ViewConfiguration.get(CurrentActivityHolder.getInstance().getContext()).getScaledMinimumFlingVelocity();
